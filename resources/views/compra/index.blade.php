<x-app-layout>
    <h1 class="text-primary my-4">Compras</h1>

    <!-- agregar nueva compra ---->
    <section class="row align-items-center justify-content-md-end g-3 mb-4">
        <div class="col-auto">
            <div class="d-flex  align-items-center">
                <a href="{{ route('compras.create') }}" class="btn btn-success bg-gradient"> <i
            ...
            <table class="table table-sm table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="col-3 shadow">Fecha de la Compra</th>
                ...
                <tbody>
                    @foreach ($compras as $compra)
                        <tr>
                            <td class="col-2 text-center align-middle">{{ $compra->id }}</td>
                            <td class="col-3 align-middle">{{ $compra->fecha_compra }}</td>
                            <td class="col-2 align-middle">{{ $compra->impuesto * 100 }}%</td>
                            <td class="col-2 align-middle">{{ $compra->total }}</td>
